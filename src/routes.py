...
from src.models import usuario_models, post_models, comentario_models, curtida_models, produto_model
...
def criar_produto():
    if request.method == "POST":
        ...
        novo_produto = produto_model.Produto(nome_produto=nome_produto, valor=float(valor), imagem=imagem_path)
